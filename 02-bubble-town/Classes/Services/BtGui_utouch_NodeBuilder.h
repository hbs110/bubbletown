...
using fnBuildNode = std::function < bool(cocos2d::Node* destNode, const rapidjson::Value& desc) > ;
...
public:
    ...
    cocos2d::Node* Create(const std::string& nodeType, const rapidjson::Value& layoutNode);
