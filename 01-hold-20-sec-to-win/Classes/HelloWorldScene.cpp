...
bool HelloWorld::init()
{
    ...
    m_shootTimer->onTrigger = std::bind(&HelloWorld::OnShootTriggered, this);
    m_shootTimer->onFinish = std::bind(&HelloWorld::OnShootFinished, this);
...
void HelloWorld::OnShootTriggered()
{
...
void HelloWorld::OnShootFinished()
{
    m_shootTimer->setupTimerWithInterval(kRepeatForever, 1, 0.0f);
}

bool HelloWorld::IsOutOfScene(cocos2d::Sprite* bullet)
{
...
void HelloWorld::OnMenuItem(Ref* sender)
{
